...
input("\nNote, there are some things you should know before starting this game."
      "\nEverytime you respond to a question, make sure you type it EXACTLY how you see")
print()
input("For example,if you are required to respond to a question,such as a yes or no question"
      "\nif you select yes, write yes EXACTLY how you see it."
      "\nIf you select no, write it exactly how you see it.")
...
input(" Don't type another answer that isn't there"
      ...
      "\n It will be marked either as a invalid answer,"
      "\nor you can potentially get a answer that you don't want"
...
print()
input("Feedback and constructive criticism is greatly appreciated."
      "\nIf you experience any bugs or issues with my game."
...
input("Course name:Bayshore route(Wangen sen)"
      ...
      "\nThe infamous street racing group who only did max velocity," 
      "\nand pushed their cars to the limit....")
print()
print()
...
if mods == "return":
    ...
    input("While walking on a bright afternoon in Yokohama,"
          ...
          "\nyou aren't finna be doing midnight runs with the bois for a while....")
yen -= 2000
...
input("Course name:Tokyo Bay Aqua-line"
      ...
      "\nThis tunnel also helped reduce the time driving time from these two prefectures" 
...
print()
input("📱"  
      "\nYou-Wait, Smokey...Smokey Nagata?!"
       "\nDidn't he go over 200MPH on a British Highway,and got arrested?!")
print()
...
smokey = input("For now, you can use one of the Top secret cars:"
               ...
               "\nTop Secret Nissan Skyline R34"
               "\n:")
if smokey == "Top Secret Toyota Supra":
    print("So i see you like stealing other peoples cars...."
          "\nespecially newer ones I see...")

elif smokey == "Top Secret Nissan Skyline R34":
    print("Shoot, i was just working on that one.")
if smokey == "Top Secret Nissan Silvia S15":
...
input("Smokey- Hmm....Interesting that you chose the " + smokey + "."
    "\nBut you my friend have made a interesting choice,"
    "\nbut for now, I'll ride in my Supra.")
print()
...
print()
input("You payed the toll,"
      "\nbut once you arrive, for some reason Smokey stopped in the middle of the road...")
print()
...
while x > 0:
    print(x)
    x -= 1
input("listed below is your"
"\nManual Transmission pattern of your " + smokey + ". ")
print()
...
input("You somehow manage to align your " + smokey + " "
      "\nright behind Smokey's car,"
...
print()
input("Since you have decided to select the " + nobita + ","
      "\nthe race between you and Koseki will now commence")
print()
input("Similar to before," 
      "\nthis is just cat and mouse race between the Aqualine to the Bayshore route.")
print()
...
print()
input("you- Hey man, what do you expect." 
     "\nThey got cameras setup in these tunnels nowadays.")
print()
input("You now end up breaking the toll booth station and end up fleeing te police"
      "\n you- Imma lay low for a bit."
      "\nKoseki- you better."
      "\nYou go drive during a breezy and  " + TOD + ","
      "\nand go whatever the roads take you....")
input("Congratulations " + playa + "!!"
      "\nYou have successfully completed phase 1 of Hashiriya Undergrounds!! ")
exit()
